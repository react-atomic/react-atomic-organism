...
import { mixClass, reactStyle, Item, SemanticUI } from "react-atomic-molecule";

let styles = reactStyle({
  WebkitTapHighlightColor: "rgba(0,0,0,0)",
  WebkitTouchCallout: "none",
  userSelect: ["none"],
  cursor: "pointer",
});
let _blockMouseEvents;
...
export default class Tappable extends Component {
  ...
  onTouchMove(event) {
    ...
    if (
      movement.x > this.props.moveThreshold ||
  ...
  render() {
    var className =
      this.props.classBase + (this.state.isActive ? "-active" : "-inactive");
    var classes = mixClass(this.props.className, className);
    return (
      <SemanticUI
        {...this.props}
