...
export const popupDispatch: (action: import("reshow-flux-base/types/createReducer").DispatchAction, actionParams?: import("reshow-flux-base/types/createReducer").Payload) => import("reshow-flux/types/ImmutableStore").StateMap;
