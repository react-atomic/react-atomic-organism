...
var _getObjectValue = __webpack_require__(40);
...
var ajaxGet = function ajaxGet(_ref) {
    ...
    }) : typeof module !== 'undefined' && module.exports && "function" !== 'undefined' || typeof module !== 'undefined' && module.component && _systemImportTransformerGlobalIdentifier.require && _systemImportTransformerGlobalIdentifier.require.loader === 'component' ? Promise.resolve(__webpack_require__((496))) : Promise.resolve(_systemImportTransformerGlobalIdentifier['superagent'])).then(function (req) {
...
var ajaxPost = function ajaxPost(_ref2) {
    ...
    (typeof _systemImportTransformerGlobalIdentifier.define === 'function' && _systemImportTransformerGlobalIdentifier.define.amd ? new Promise(function (resolve, reject) {
        ...
        postReq.set('Accept', (0, _getObjectValue2.default)(params, ['accept'], 'application/json')).end(function (err, res) {
            if (res) {
                var error = res.error,
                    _req2 = res.req,
                    text = res.text,
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(105)(module)))
...
var RequestBase = __webpack_require__(498);
var isObject = __webpack_require__(495);
var isFunction = __webpack_require__(499);
var ResponseBase = __webpack_require__(500);
var shouldRetry = __webpack_require__(502);
