...
describe('Test fixHtml', () => {
  ...
  it('test doctype', ()=>{
    ...
    const expected = '<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml"><head></head><body></body></html>';
  ...
  it('convert xml to html', ()=>{
    const input = '&amp;';
    const a = fixHtml(input, sanitizeHtml);
    const expected = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>&</body></html>';
    expect(a).to.equal(expected);
  });
