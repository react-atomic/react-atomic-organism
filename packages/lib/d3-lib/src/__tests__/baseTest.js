...
describe('curve', () => {
  ...
  it('data', () => {
    ...
    const expected = 'M68.34532374100718,192C68.34532374100718,192,119.09016773530556,-1.846453936567319,140.28776978417264,0C169.58513998737726,2.551998307075889,175.79345245068353,302.0583204180711,212.2302158273381,385C232.395813002623,430.9033224823245,258.4117898934848,477.7738860797655,284.1726618705036,481C306.7822821646624,483.8314728952993,334.4705184481537,449.174180543014,356.115107913669,423C383.96322178568744,389.32407551873786,402.4835319141224,289.90270574356003,428.05755395683445,288C450.78058394406463,286.30940789854714,499.99999999999994,385,499.99999999999994,385';
...
describe('line', () => {
  ...
  it('test get line', () => {
    ...
    const expected = 'M0,0L0.8333333333333334,0C1.6666666666666667,0,3.3333333333333335,0,5,1.6666666666666667C6.666666666666667,3.3333333333333335,8.333333333333334,6.666666666666667,9.166666666666666,8.333333333333334L10,10';
...
describe('area', () => {
  it('hArea', () => {
    let data = [{x: 1, y0: 3, y1: 3}, {x: 4, y0: 5, y1: 6}];
