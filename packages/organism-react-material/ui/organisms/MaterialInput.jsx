...
import { Field, SemanticUI, reactStyle } from "react-atomic-molecule";
...
class MaterialInput extends PureComponent {
  ...
  getLabelFocusStyle() {
    ...
    const focusStyles = labelFocusStyles ? labelFocusStyles : Styles.labelFocus;
      ...
      >
        <SemanticUI styles={Styles.cardInputBar}>
          <span
            ...
            style={{ ...Styles.inputBarFocus, ...Styles.inputBarLeft }}
          />
          <span
            styles={this.state.barFocus}
            style={{ ...Styles.inputBarFocus, ...Styles.inputBarRight }}
          />
        </SemanticUI>
      </Field>
    );
