...
var isObject = __webpack_require__(/*! ./is-object */ 6);
...
/* harmony import */ var reshow_runtime_es_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! reshow-runtime/es/helpers/classCallCheck */ 4);
/* harmony import */ var reshow_runtime_es_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! reshow-runtime/es/helpers/createClass */ 5);
...
/* harmony import */ var _register_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./register.mjs */ 9);
...
/* harmony import */ var _register_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register.mjs */ 9);
...
/* harmony import */ var win_doc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! win-doc */ 8);
...
var toMap = function toMap(a, path) {
  var next = (0,_get_mjs__WEBPACK_IMPORTED_MODULE_1__["default"])(a, path, {});
  var nextMap = {};

  if (next.forEach) {
    next.forEach(function (v, k) {
      return nextMap[k] = (0,_toJS_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])(v);
    });
  } else {
    (0,reshow_constant__WEBPACK_IMPORTED_MODULE_0__.KEYS)(next).forEach(function (k) {
      return nextMap[k] = (0,_toJS_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])(next[k]);
    });
  }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var reshow_runtime_es_helpers_createClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! reshow-runtime/es/helpers/createClass */ 5);
/* harmony import */ var reshow_runtime_es_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! reshow-runtime/es/helpers/classCallCheck */ 4);
/* harmony import */ var reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! reshow-runtime/es/helpers/defineProperty */ 2);
...
/* harmony import */ var win_doc__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! win-doc */ 8);
...
/* harmony import */ var reshow_runtime_es_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! reshow-runtime/es/helpers/createClass */ 5);
/* harmony import */ var reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! reshow-runtime/es/helpers/defineProperty */ 2);
/* harmony import */ var reshow_runtime_es_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! reshow-runtime/es/helpers/objectWithoutPropertiesLoose */ 19);
/* harmony import */ var reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! reshow-runtime/es/helpers/objectSpread2 */ 20);
/* harmony import */ var get_object_value__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! get-object-value */ 22);
/* harmony import */ var non_worker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! non-worker */ 36);
/* harmony import */ var superagent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! superagent */ 7);
/* harmony import */ var parse_ini_string__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! parse-ini-string */ 39);
/* harmony import */ var object_nested__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! object-nested */ 40);
/* harmony import */ var reshow_constant__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! reshow-constant */ 0);
...
var oNonWorker = new non_worker__WEBPACK_IMPORTED_MODULE_6__["default"](function (e) {
  var data = (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(e, ["data"]);
...
var post = function post(payload) {
  var strWcb = (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(payload, ["params", "workerCallback"]);
  var parseIni = (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(payload, ["params", "ini"]);
  var text = (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(payload, ["params", "text"]);
  payload.params.json = parseIni ? (0,object_nested__WEBPACK_IMPORTED_MODULE_9__.nest)((0,parse_ini_string__WEBPACK_IMPORTED_MODULE_8__["default"])(text), "_") : getJson(text);
...
var cookParams = function cookParams(action, callReq) {
  ...
  var cookHeaders = (0,reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__["default"])((0,reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__["default"])((0,reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__["default"])({}, (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(params, ["globalHeaders"], {})), (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(params, ["headers"], {})), {}, {
    Accept: (0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(params, ["accept"], "application/json")
  });
  ...
  (0,reshow_constant__WEBPACK_IMPORTED_MODULE_10__.KEYS)(superagent).forEach(function (key) {
...
var ajaxGet = function ajaxGet(_ref) {
  var url = _ref.url,
      action = _ref.action;
  var callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.get(url);
  ...
  callReq.query(query).set(cookHeaders).end(function (err, res) {
    if (res) {
      ...
      var error = res.error,
          ...
          text = res.text,
          xhr = res.xhr,
          response = (0,reshow_runtime_es_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__["default"])(res, _excluded);

      action.params = (0,reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__["default"])((0,reshow_runtime_es_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_4__["default"])({}, action.params), {}, {
        text: text,
        response: response
      });
      post(action);
...
var ajaxPost = function ajaxPost(_ref2) {
  ...
  switch ((0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(action, ["params", "method"])) {
    case "delete":
      callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.del(url);
      break;

    case "head":
      callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.head(url);
      break;

    case "patch":
      callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.patch(url);
      break;

    case "put":
      callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.put(url);
      break;

    default:
      callReq = superagent__WEBPACK_IMPORTED_MODULE_7__.post(url);
      break;
  }
  ...
  var _cookParams2 = cookParams(action, callReq),
      ...
      params = (0,reshow_runtime_es_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__["default"])(_cookParams2, _excluded2);
  ...
  if (isSendJson) {
    ...
    if (null == isSendJson && query) {
      (0,reshow_constant__WEBPACK_IMPORTED_MODULE_10__.KEYS)(query).every(function (key) {
  ...
  callReq.send(query).set(cookHeaders).end(function (err, res) {
    if (res) {
      ...
      var error = res.error,
          ...
          text = res.text,
          xhr = res.xhr,
          response = (0,reshow_runtime_es_helpers_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__["default"])(res, _excluded3);
...
var WebSocketHelper = /*#__PURE__*/function () {
  function WebSocketHelper(url, params) {
    (0,reshow_runtime_es_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, WebSocketHelper);

    (0,reshow_runtime_es_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "isWsConnect", false);
  ...
  (0,reshow_runtime_es_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WebSocketHelper, [{
    key: "open",
    value: function open() {
      var _this2 = this;
      ...
      ws.onopen = function (e) {
        ...
        if ((0,get_object_value__WEBPACK_IMPORTED_MODULE_5__["default"])(messages, ["length"])) {
